...
class Root extends React.Component {
    ...
    checkAnswer = (e) => {
        e.preventDefault();
        this.state.value === this.state.rebus.name ? this.setState(prevState=>({isRightAnswer: !prevState.isRightAnswer})) : this.setState(prevState=>({isWrongAnswer: !prevState.isWrongAnswer}))
    }
