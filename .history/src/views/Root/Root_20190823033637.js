...
class Root extends React.Component {
    ...
    handleChange = (e) => {
        let letters = this.state.rebus.name.split('');
        console.log('letters',letters.map((item, index)=> letters[index]))
        let letter = this.state.value.split('');
        console.log('letter', letter.map((item, index)=> letter[index]))
        this.setState({
            value: this.state.value + e.target.value.toLowerCase()
        }()=> console.log(this.state.value););
