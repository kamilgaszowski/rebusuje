                    ...
                    <form className={styles.form} onSubmit={checkAnswer}>
                        ...
                        <div className={styles.inputs}>
                            <input
                                ...
                                className={name === value ? styles.input_right : styles.input}
                                type='text'
                                autoComplete='off'
                                required
                            />
                            {/* <div className={styles.check}>
                                <p className={isRightAnswer ? styles.active  : styles.right  }>V</p>
                                <p className={isWrongAnswer ? styles.active : styles.wrong}>X</p>
                            </div> */}
                        </div>
