                        ...
                        <label>
                           {!isWrongAnswer && !isRightAnswer ? 'Wpisz swoje rozwiązanie:' : (isRightAnswer ? 'Prawidłowa odpowiedź' : 'Spróbuj jeszcze raz') }
                            ...
                            <div className={styles.check}>
                                {!isWrongAnswer && !isRightAnswer ? (<CheckCircleIcon className={styles.hidden_icon}/>) : (isRightAnswer ? <CheckCircleIcon className={styles.right_hidden}/> : <CheckCircleIcon className={styles.wrong_hidden}/>)}
