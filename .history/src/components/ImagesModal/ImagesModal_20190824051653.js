                        ...
                        <label>
                           {!isWrongAnswer && !isRightAnswer ? 'Wpisz swoje rozwiązanie:' : (isRightAnswer ? 'Prawidłowa odpowiedź' : 'Spróbuj jeszcze raz') }
                            ...
                            <div className={styles.check}>
                                {isRightAnswer ? (<Icon className={styles.right}>check_circle</Icon>) : (<Icon className={styles.right_hidden}>check_circle</Icon>)}
                                {isWrongAnswer ? (<Icon className={styles.wrong}>check_circle</Icon>) : (<Icon className={styles.wrong_hidden}>check_circle</Icon>)}
