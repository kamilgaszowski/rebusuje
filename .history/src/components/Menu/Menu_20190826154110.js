    ...
    <nav >
        <ul className={styles.menu}>
            ...
            <div className={styles.container}>
                <li >
                    <NavLink className={styles.nav_item} activeClassName={styles.active} exact to="/gallery" onClick={props.onCloseRebus}>
                        {/* <img src='https://i.postimg.cc/15X9wTT8/menu.png' alt='home' /> */}
                        <p>Galeria</p>
                    </NavLink>
                </li>
                <li >
                    <NavLink  className={styles.nav_item} activeClassName={styles.active}to="/contact" onClick={props.onCloseRebus}>
