            ...
            <div className={styles.container}>
                <li>
                    <NavLink
                        ...
                        {/* <img className={styles.icon} src='https://i.postimg.cc/15X9wTT8/menu.png' alt='home' /> */}
                        {/* <p>Galeria</p> */}
                    </NavLink>
                </li>
                <li>
                    <NavLink
                        ...
                        {/* <img className={styles.icon} src='https://i.postimg.cc/2yx4bcQD/baseline-alternate-email-black-48dp.png' alt='home' /> */}
                        {/* <p>Kontakt</p> */}
                    </NavLink>
                </li>
            </div>
