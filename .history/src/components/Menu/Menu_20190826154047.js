    ...
    <nav >
        <ul className={styles.menu}>
            ...
            <div className={styles.container}>
                <li className={styles.nav_item}>
                    <NavLink activeClassName={styles.active} exact to="/gallery" onClick={props.onCloseRebus}>
                        {/* <img src='https://i.postimg.cc/15X9wTT8/menu.png' alt='home' /> */}
                        <p>Galeria</p>
                    </NavLink>
                </li>
                <li className={styles.nav_item}>
                    <NavLink  activeClassName={styles.active}to="/contact" onClick={props.onCloseRebus}>
